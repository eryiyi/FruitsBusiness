...
import com.lbins.FruitsBusiness.adapter.LvAdapter;

import java.util.Date;

public class PullToRefreshLV extends ListView implements OnScrollListener {
	...
	public PullToRefreshLV(Context context) {
		super(context);
		init(context);
	}

	public PullToRefreshLV(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	public PullToRefreshLV(Context context, AttributeSet attrs, int defStyle) {
