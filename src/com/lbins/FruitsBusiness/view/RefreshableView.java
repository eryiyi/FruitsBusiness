package com.lbins.FruitsBusiness.view;
...
public class RefreshableView extends LinearLayout {
	...
	private void init() {
		...
		//下拉显示text
		 ...
		 downTextView.setTextColor(mContext.getResources().getColor(R.color.common_grey));
		//下来显示时间
		...
		downTextString = mContext.getResources().getString(R.string.pull_to_refresh_pull_label);
	...
	private void doMovement(int moveY) {
		...
		if(lp.topMargin >  0){
			...
			refreshIndicatorView.setImageResource(R.drawable.ic_pulltorefresh_arrow_up);
		}else{
			downTextView.setText(R.string.pull_to_refresh_pull_label);
			refreshIndicatorView.setImageResource(R.drawable.ic_pulltorefresh_arrow);
		}
